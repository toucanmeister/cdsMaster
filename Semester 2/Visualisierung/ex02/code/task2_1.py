...
# a)
axs1.annotate('', (50,50), (0,0), arrowprops={'width': 3, 'shrink': 0.01})
...
# b)
x, y = np.meshgrid(np.arange(10,100,10), np.arange(10,100,10))
axs2.scatter(x, y)
...
# c)
contours = axs3.contour(X, Y, Z, [0, 0.4, 0.8], cmap=ListedColormap(['black']))
...
# d)
axs4.contour3D(X, Y, Z, [0, 0.4, 0.8], cmap=ListedColormap(['black']))
axs4.contour(X, Y, Z, [0, 0.4, 0.8], cmap=ListedColormap(['black']), offset=-1)
