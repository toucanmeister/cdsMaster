...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{figs/results/logZ_diffs_spike_20d.png}
    \includegraphics[scale=0.5]{figs/results/logZ_diffs_spike_offcenter_20d.png}
...
For how well the configurations found the posterior modes, where the main challenge is finding the small spike, two criteria were implemented.

The first criterion checks, for each mode, if there is a dead point within the 95th percentile of cumulative probability of the mode, and labels the mode as found if there is.
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{figs/results/modes_found_spike_20d.png}
    \includegraphics[scale=0.5]{figs/results/modes_found_spike_offcenter_20d.png}
...
\begin{figure}
    \centering
    \includegraphics[trim={0cm 0cm 2cm 0cm}, clip, scale=0.5]{figs/results/KLDs_spike_20d.png}
    \includegraphics[scale=0.5]{figs/results/KLD_spike_20d_reflection.png}
    \includegraphics[scale=0.5]{figs/results/KLDs_spike_offcenter_20d.png}
    \caption{Box plots of the KLD of estimated and true mode weights. Top: $L_1$-example, Bottom: $L_2$-example. The results for HMC with reflection are presented on a separate scale to enable better comparison between the others. Orange lines are the median values, gray crosses are the mean values.}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{figs/results/iterations_spike_20d.png}
    \includegraphics[scale=0.5]{figs/results/iterations_spike_offcenter_20d.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{figs/results/acceptance_rates_spike_20d.png}
    \includegraphics[scale=0.5]{figs/results/acceptance_rates_spike_offcenter_20d.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{figs/results/mean_jump_distances_spike_20d.png}
    \includegraphics[scale=0.5]{figs/results/mean_jump_distances_spike_offcenter_20d.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_metropolis_t_05}
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_metropolis_t_1}
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_metropolis_t_2}
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_metropolis_t_5}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_hmc_t_05}
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_hmc_t_1}
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_hmc_t_2}
    \includegraphics[width=0.5\textwidth]{figs/results/params/jump_distances_hmc_t_5}
