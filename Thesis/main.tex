...
\begin{figure}
    ...
    \caption{Bar charts of how often each number of modes was found by each configuration. Orange lines are the median values, gray crosses are the mean values.}
