...
\begin{figure}
    ...
    \caption{Box plots of how many of the two modes were found by each method. Top: $L_1$-example, Bottom: $L_2$-example. Orange lines are the median values, gray crosses are the mean values.}
