...
Standard Markow-Chain-Monte-Carlo-Verfahren sind hier dadurch limitiert, dass sie die Likelihood-Grenze erst dann bemerken, wenn sie sie bereits überschritten haben.
In dieser Arbeit stelle ich Nested Sampling mit Barrieren vor; eine Methode, die die Idee einer logarithmischen Barrierefunktion aus der konvexen Optimierung in Nested Sampling integriert, um das likelihoodbeschränkte Sampling des Priors gezielt zu lenken.
...
In standard Nested Sampling, this step is limited by samplers not noticing the likelihood-constraint boundary until they have crossed it, causing low acceptance rates of samples.
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6, trim={1.5cm 1.5cm 1.5cm 1.5cm},clip]{spike_example.png}
    \includegraphics[scale=0.6, trim={1.5cm 1.5cm 1.5cm 1.5cm},clip]{gauss_example.png}
