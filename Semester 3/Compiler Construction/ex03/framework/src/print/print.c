...
PRTmodule (node * arg_node, info * arg_info)
{
  ...
  printf("Counted %d addition operations.\n", MODULE_ADD_COUNT( arg_node));
  printf("Counted %d subtraction operations.\n", MODULE_SUB_COUNT( arg_node));
  printf("Counted %d multiplication operations.\n", MODULE_MUL_COUNT( arg_node));
  printf("Counted %d division operations.\n", MODULE_DIV_COUNT( arg_node));
  printf("Counted %d modulo operations.\n", MODULE_MOD_COUNT( arg_node));
