...
extern node *CHKboolconst (node * arg_node, info * arg_info);
extern node *CHKcast (node * arg_node, info * arg_info);
extern node *CHKdecblock (node * arg_node, info * arg_info);
extern node *CHKdowhile (node * arg_node, info * arg_info);
extern node *CHKfloatconst (node * arg_node, info * arg_info);
extern node *CHKfor (node * arg_node, info * arg_info);
extern node *CHKfunargs (node * arg_node, info * arg_info);
...
extern node *CHKfunparam (node * arg_node, info * arg_info);
extern node *CHKfunparams (node * arg_node, info * arg_info);
extern node *CHKif (node * arg_node, info * arg_info);
extern node *CHKintconst (node * arg_node, info * arg_info);
extern node *CHKmodule (node * arg_node, info * arg_info);
extern node *CHKmonop (node * arg_node, info * arg_info);
extern node *CHKproccall (node * arg_node, info * arg_info);
extern node *CHKreturn (node * arg_node, info * arg_info);
extern node *CHKvardec (node * arg_node, info * arg_info);
extern node *CHKvariable (node * arg_node, info * arg_info);
