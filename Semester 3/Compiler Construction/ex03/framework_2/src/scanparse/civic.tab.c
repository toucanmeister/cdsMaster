...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OR = 18,                        /* OR  */
  YYSYMBOL_AND = 19,                       /* AND  */
  YYSYMBOL_TRUEVAL = 20,                   /* TRUEVAL  */
  YYSYMBOL_FALSEVAL = 21,                  /* FALSEVAL  */
  YYSYMBOL_LET = 22,                       /* LET  */
  YYSYMBOL_NUM = 23,                       /* NUM  */
  ...
  YYSYMBOL_varlet = 31,                    /* varlet  */
  YYSYMBOL_expr = 32,                      /* expr  */
  YYSYMBOL_constant = 33,                  /* constant  */
  YYSYMBOL_floatval = 34,                  /* floatval  */
  YYSYMBOL_intval = 35,                    /* intval  */
  YYSYMBOL_boolval = 36,                   /* boolval  */
  YYSYMBOL_binop = 37                      /* binop  */
};
...
static const char *const yytname[] =
{
  ...
  "BRACKET_R", "COMMA", "SEMICOLON", "MINUS", "PLUS", "STAR", "SLASH",
  "PERCENT", "LE", "LT", "GE", "GT", "EQ", "NE", "OR", "AND", "TRUEVAL",
  "FALSEVAL", "LET", "NUM", "FLOAT", "ID", "$accept", "program", "stmts",
  "stmt", "assign", "varlet", "expr", "constant", "floatval", "intval",
